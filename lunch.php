...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    ?>
                       <div>
                           ...
                           <a href="#" data-toggle="modal" data-target="#LunchModal">
                               <button class = "add">
    ...
    <!-- modal create -->
    <div class="modal fade" id="LunchModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Insert Lunch</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <label for="name_lunch">Lunch Name</label><br>
                    <input type="text" name="name_lunch" value="<?php if(isset($_POST['name_lunch'])) echo $_POST['name_lunch'];?>"><br><br>
                    <label for="price_lunch">Lunch Price</label><br>
                    <input type="number" name="price_lunch" value="<?php if(isset($_POST['price_lunch'])) echo $_POST['price_lunch'];?>"><br><br>
                    <label for="material_lunch">Lunch material</label><br>
                    <input type="text" name="material_lunch" value="<?php if(isset($_POST['material_lunch'])) echo $_POST['material_lunch'];?>"><br><br>
                    <label for="img">Image Lunch</label><br>
                    <input type="file" name="image" value=""/><br><br>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <!-- <button name="btn_lunch">Save</button> -->
                    <input type="submit" name="btn_lunch" value='Save' >
                    </form>
                </div>
            </div>
        </div>
    ...
    <?php
    if(isset($_POST['btn_lunch'])){

        $name = $_POST['name_lunch'];
        $price = $_POST['price_lunch'];
        $material = $_POST['material_lunch'];
        // $img = $_POST['img'];
        $img = $_FILES['image']['name'];
        $tempname = $_FILES['image']['tmp_name'];

        if(!empty($name) && !empty($price) && !empty($material) && !empty($img)){
            $folder = "img_lunch/".$img;
            ...
            $data = array(  
                ...
                'D_role'=> mysqli_real_escape_string($conn->getCon(),'lunch')
         );
