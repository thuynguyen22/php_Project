                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                ...
                                                $where = array('user_role'=>'user');
                                                $result = $conn->count('user_web', $where);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                ...
                                                require_once 'connect.php';
                                                $conn = new database('localhost', 'root', '', 'php_project');
                                                // $where = array('or_id'=>'lunch');
                                                $result = $conn->count_order('dat_hang');
                                                $row = $result->fetch_assoc();
                                                echo $row['total'];
                                                ?>
                                            </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total of product</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php 
                                                require_once 'connect.php';
                                                $conn = new database('localhost', 'root', '', 'php_project');
                                                // $where = array('or_id'=>'lunch');
                                                $result = $conn->count_order('dish');
                                                $row = $result->fetch_assoc();
                                                echo $row['total'];
                                                ?>
                                            </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Number of Breakfast product</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php 
                                                require_once 'connect.php';
                                                $conn = new database('localhost', 'root', '', 'php_project');
                                                $where = array('D_role'=>'breakfast');
                                                $result = $conn->count('dish', $where);
                                                $row = $result->fetch_assoc();
                                                echo $row['total'];
                                                ?>
                                            </div>
