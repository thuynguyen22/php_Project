...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    ?>
                       <div>
                           ...
                           <a href="#" data-toggle="modal" data-target="#BreakModal">
                               <button class = "add">
    ...
    <!-- modal create -->
    <div class="modal fade" id="BreakModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Insert Breakfast</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <label for="name_break">Breakfast Name</label><br>
                    <input type="text" name="name_break" value="<?php if(isset($_POST['name_break'])) echo $_POST['name_break'];?>"><br><br>
                    <label for="price_break">Breakfast Price</label><br>
                    <input type="number" name="price_break" value="<?php if(isset($_POST['price_break'])) echo $_POST['price_break'];?>"><br><br>
                    <label for="material_break">Breakfast material</label><br>
                    <input type="text" name="material_break" value="<?php if(isset($_POST['material_break'])) echo $_POST['material_break'];?>"><br><br>
                    <label for="img">File Image Breakfast</label><br>
                    <input type="file" name="image" value=""/><br><br>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <!-- <button name="btn_break">Save</button> -->
                    <input type="submit" name="btn_break" value='Save' >
                    </form>
                </div>
            </div>
        </div>
    ...
    <?php
    if(isset($_POST['btn_break'])){

        $name = $_POST['name_break'];
        $price = $_POST['price_break'];
        $material = $_POST['material_break'];
        // $img = $_POST['img'];
        $img = $_FILES['image']['name'];
        $tempname = $_FILES['image']['tmp_name'];

        if(!empty($name) && !empty($price) && !empty($material) && !empty($img)){
            $folder = "img_breakfast/".$img;
            ...
            $data = array(  
                ...
                'D_role'=> mysqli_real_escape_string($conn->getCon(),'breakfast')
         );
