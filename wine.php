...
<body id="page-top">
    ...
    <!-- modal create -->
    <div class="modal fade" id="WineModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Insert Wine</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <label for="name_wine">Wine Name</label><br>
                    <input type="text" name="name_wine" value="<?php if(isset($_POST['name_wine'])) echo $_POST['name_wine'];?>"><br><br>
                    <label for="price_wine">Wine Price</label><br>
                    <input type="number" name="price_wine" value="<?php if(isset($_POST['price_wine'])) echo $_POST['price_wine'];?>"><br><br>
                    <label for="material_wine">Wine material</label><br>
                    <input type="text" name="material_wine" value="<?php if(isset($_POST['material_wine'])) echo $_POST['material_wine'];?>"><br><br>
                    <label for="img">Image Wine</label><br>
                    <input type="file" name="image" value=""/><br><br>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <!-- <button name="btn_wine">Save</button> -->
                    <input type="submit" name="btn_wine" value='Save' >
                    </form>
                </div>
            </div>
        </div>
    ...
    <?php
    if(isset($_POST['btn_wine'])){

        $name = $_POST['name_wine'];
        $price = $_POST['price_wine'];
        $material = $_POST['material_wine'];
        // $img = $_POST['img'];
        ...
        if(!empty($name) && !empty($price) && !empty($material) && !empty($img)){
            ...
            $data = array(  
                ...
                'D_role'=> mysqli_real_escape_string($conn->getCon(),'wine')
         );
