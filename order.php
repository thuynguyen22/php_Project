            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        $results = $conn->select_where('user_web', $where); 
                        $rows = $results->fetch_assoc();
                        ?>
                        <td><?php echo $rows['user_name'];?></td>
                        <td><?php echo $row['or_price'];?></td>
                        <td><?php echo $row['or_status'];?></td>
                        <td><?php echo $row['or_go_time'];?></td>
                        <td><?php echo $row['or_time'];?></td>
                        <td><?php echo $row['or_address'];?></td>
                        <td>
                        <a href="./delete_order.php?or_id=<?php echo $row['or_id'] ?>"><i class="fas fa-trash-alt"></i></a>
                        </td>
                        <td>
                        <a href="./update_order.php?or_id=<?php echo $row['or_id'] ?>"> <i class="fas fa-edit"></i></a>
                        </td>
                        <td>
                        <a href="./detail_order.php?or_id=<?php echo $row['or_id'] ?>"> <i class="fas fa-list"></i></a>
                        </td> 
                        </tr>
                        <?php
                        }
