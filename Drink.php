...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    ?>
                       <div>
                           ...
                           <a href="#" data-toggle="modal" data-target="#DrinkModal">
                               <button class = "add">
    ...
    <!-- modal create -->
    <div class="modal fade" id="DrinkModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <label for="name_drink">Drink Name</label><br>
                    <input type="text" name="name_drink" value="<?php if(isset($_POST['name_drink'])) echo $_POST['name_drink'];?>"><br><br>
                    <label for="price_drink">Drink Price</label><br>
                    <input type="number" name="price_drink" value="<?php if(isset($_POST['price_drink'])) echo $_POST['price_drink'];?>"><br><br>
                    <label for="material_drink">Drink material</label><br>
                    <input type="text" name="material_drink" value="<?php if(isset($_POST['material_drink'])) echo $_POST['material_drink'];?>"><br><br>
                    <label for="img">Image Drink</label><br>
                    <input type="file" name="image" value=""/><br><br>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <!-- <button name="btn_drink">Save</button> -->
                    <input type="submit" name="btn_drink" value='Save' >
                    </form>
                </div>
            </div>
        </div>
    ...
    <?php
    if(isset($_POST['btn_drink'])){

        $name = $_POST['name_drink'];
        $price = $_POST['price_drink'];
        $material = $_POST['material_drink'];
        // $img = $_POST['img'];
        $img = $_FILES['image']['name'];
        $tempname = $_FILES['image']['tmp_name'];

        if(!empty($name) && !empty($price) && !empty($material) && !empty($img)){
            $folder = "img_drink/".$img;
            ...
            $data = array(  
                ...
                'D_role'=> mysqli_real_escape_string($conn->getCon(),'drink')
         );
