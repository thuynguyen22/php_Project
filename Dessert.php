...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    ?>
                       <div>
                           ...
                           <a href="#" data-toggle="modal" data-target="#DessertModal">
                               <button class = "add">
    ...
    <!-- modal create -->
    <div class="modal fade" id="DessertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Insert Dessert</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <label for="name">Dessert Name</label><br>
                    <input type="text" name="name" value="<?php if(isset($_POST['name'])) echo $_POST['name'];?>"><br><br>
                    <label for="price">Dessert Price</label><br>
                    <input type="number" name="price" value="<?php if(isset($_POST['price'])) echo $_POST['price'];?>"><br><br>
                    <label for="material">Dessert material</label><br>
                    <input type="text" name="material" value="<?php if(isset($_POST['material'])) echo $_POST['material'];?>"><br><br>
                    <label for="img"> Image Dessert</label><br>
    ...
    if(isset($_POST['btn'])){
        ...
        if(!empty($name) && !empty($price) && !empty($material) && !empty($img)){
            ...
            $data = array(  
                ...
                'D_role'=> mysqli_real_escape_string($conn->getCon(),'dessert')
         );
